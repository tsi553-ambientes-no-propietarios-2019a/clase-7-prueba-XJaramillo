...
if($_POST) {
	if (isset($_POST['Nombre_de_Tienda']) && isset($_POST['Usuario'])
        && isset($_POST['Clave']) && !empty($_POST['Nombre_de_Tienda']) && !empty($_POST['Usuario'])&& !empty($_POST['Clave'])){
		...
		header('Location: ../registro_tienda.php?error_message= Favor Ingrese todos los datos');
		exit;
	}
} else {
